...
#ifndef STEPFLOW_VERSION_STRING
...
#else
#define CONTROLLED_VALUES_VERSION_NUMBER (STEPFLOW_VERSION_NUMBER)
#define CONTROLLED_VALUES_VERSION_STRING {STEPFLOW_VERSION_STRING}
#endif
