...
#if !(WINDOWS_POINT||DRAWING_POINT)
#define DRAWING_POINT
#endif  
...
namespace Win32Imports
{
    public class SystemMetrics
    {
        ...
        private static extern RETURN_CODE SystemParametersInfo( PARAMETER_QUERY which, UInt32 uiParam,
                                                                IntPtr pResult, UInt32 fWinIni );
        ...
        public static int DOUBLECLICKTIME {
            get { UInt32 dblClickTime; unsafe { IntPtr getter = new IntPtr(&dblClickTime);
                    if( !SystemParametersInfo( PARAMETER_QUERY.SPI_GETDOUBLECLICKTIME, 0, getter, 0 ) )
        ...
        public static bool MOUSEWHEELPRESENT {
            get {
                return Get(METRICS_REQUEST.SM_MOUSEWHEELPRESENT).u32 > 0;
            }
        }
        public static bool MOUSEHORIZONTALWHEELPRESENT {
            get {
                return Get(METRICS_REQUEST.SM_MOUSEHORIZONTALWHEELPRESENT).u32 > 0;
            }
        }
        public static int MOUSEBUTTONS {
            get {
                return (int)Get(METRICS_REQUEST.SM_CMOUSEBUTTONS).u32;
            }
        }
        public static int MAXIMUMTOUCHES {
            get {
                return (int)Get(METRICS_REQUEST.SM_MAXIMUMTOUCHES).u32;
            }
        }
        public static int PENWINDOWS {
            get {
                return (int)Get(METRICS_REQUEST.SM_PENWINDOWS).u32;
            }
        }
        public static bool MULTIPOINTER {
            get {
                return DIGITIZR.HasFlag(DIGITIZER_FLAGS.MULTIPOINTER);
            }
        }
        ...
        public static Point SCALEDFULLSCREEN {
            get {  Point full = new Point( 
                    (int)GetSystemMetrics(METRICS_REQUEST.SM_CXFULLSCREEN).u32,
                    (int)GetSystemMetrics(METRICS_REQUEST.SM_CYFULLSCREEN).u32 );
                Point scale = SCREENSCALE;
                int x = (int)(full.X *= scale.X);
                int y = (int)(full.Y *= scale.Y);
                unsafe { (*(RETURN_CODE*)&x).log("SCALEDFULLSCREEN.X");
                         (*(RETURN_CODE*)&y).log("SCALEDFULLSCREEN.Y"); }
                return full;        
            }
        }
