...
namespace TestQualle
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private DispatcherTimer dTimer1;
        private App App;
        ...
        public QuallenBlubberer bluber;
        ...
        public Int32Rect TheOtherSize {
            get {
                return new Int32Rect((int)( screenScale.X * usedScreenSize.X * location.X ),
        ...
        public Point position {
            get { return (location * usedScreenSize) - (Vector)Pivot; }
            private set {
                location.VAL = new Point( (value.X + (Width / 2)) / usedScreenSize.X,
        ...
        public Point Pivot {
            get { return (Point)( (Vector)Size / 2.0 ); }
        }

        public Point Center {
            get { return location * usedScreenSize; }
        }
                          ...
                          bool virtualScreenScale )
        {
            ...
            if( QuallenserverAddress.StartsWith("pack") ) {
                bluber.LoadFromLocation(App.Current.Resources["BLUBBERER"] as Uri);
            } else {
        ...
        void dTimer1_Tick( object sender, EventArgs e )
        {
            ...
            if( direction != DIRECTION.EXPLODING ) {
                ...
                if( mousen.ControllerActive ) { // if mousen active, prepare offsets from distance to the 
                ...
                if( ++counter >= interval2 ) {
                    ...
                    // point) and decide by random if oscillation should go on within same direction or if it should switch to opposide direction.
        ...
        {
            if( mousen.ControllerActive || mouseFollow ) { // check 'Wo Is Die Maus?'
                mousen.VAL = e.GetPosition((Window)sender);
            }
        }
